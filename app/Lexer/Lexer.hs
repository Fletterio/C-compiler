...
alex_table = listArray (0 :: Int, 1450)
  [ 0
  , 12
  , 12
  , 12
...
alex_check = listArray (0 :: Int, 1450)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_1 = tokenConstant
alex_action_2 = tokenInt
alex_action_3 = tokenVoid
alex_action_4 = tokenReturn
alex_action_5 = tokenLParen
alex_action_6 = tokenRParen
alex_action_7 = tokenLBrace
alex_action_8 = tokenRBrace
alex_action_9 = tokenSemicolon
alex_action_10 = tokenIdentifier
alex_action_11 = \(_, _, str, _) len -> alexError ("Invalid constant: " ++ (BS.unpack $ BS.take len str))
